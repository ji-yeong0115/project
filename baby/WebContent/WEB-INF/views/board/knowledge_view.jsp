...
<body>
	  	...
	  	<%@ include file="../common/aside.jsp" %>
		  	...
		  	<div class="my-5" id="content-main" style="padding-left: 15px;">
				...
				<div id="notice-area" style="width: 100%;">
                  ...
                  <div class="row top-margin width-100 margin-none">
                    <div class="col-md-12 margin-none padding-none width-100">
                      ...
                      <% if(loginMember != null && loginMember.getMemberGrade().equals("A")) {%>
	                      ...
	                      <a href="updatekBoardForm.do?type=<%=type%>&no=<%=boardNo%>&cp=<%=cp %>" class="btn btn-primary modBtn ml-1 mr-1">수정</a>                      
                      <%} %>
                  ...
                  <!-- 게시글이 작성된 공간 -->
                  <div class="row solid board-area" style="width: 100%;" >
                  ...
                  <div class="row top-margin">
                    ...
                    <a href="http://www.cdc.go.kr/gallery.es?mid=a20509000000&bid=0007" >관련 출처 링크</a>
                      <a href="knowledgeForm.do?type=<%=type%>&cp=<%=cp%>&age=0" class="btn btn-primary" style="float: right;">목록</a>
                    </div>            
                  </div>
	...
	<script>
		...
		$("#deleteBtn").on("click", function(){
			if(confirm("정말 삭제 하시겠습니까?")) location.href = "deleteKnowledge.do?no=<%=boardNo %>&type=<%=type%>&cp=<%=cp%>";
		});
