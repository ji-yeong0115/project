	...
	<div class="container-fluid">
		...
		<div class="row" id="content">
			...
			<!-- content & aside -->
		     ...
		     <div class="row">
		     <form action="updateDiary.do?diaryNo=<%=diary.getDiaryNo()%>" method="POST" enctype="multipart/form-data" id="diary_form">
		       <div class="col-md-2" style="margin-top: 15px;">
		         <div class="boardImg" id="titleImgArea">
		           <img id="titleImg" width="150" height="150" src="<%=request.getContextPath()%>/resources/diaryImages/<%=fileName%>">
		         </div>
		       </div>
		       <div class="col-md-9">
		         <p><span id="counter">0</span>/150</p>
		         <textarea id="diaryContent" rows="5" style="resize:none; width: 100%;" name="diaryContent"><%=diary.getDiaryContent()%></textarea>
		       </div>
		       <div class="col-md-1" id="diary_btn">
		         <button class="btn btn-primary">수정</button> <br><br>
		         <a class="btn btn-primary" href="<%=request.getContextPath()%>/mypage/babyDiaryForm.do">취소</a>
		       </div>
		       <!-- 파일 업로드 하는 부분 -->
		       <div id="fileArea">
		         <!--  multiple 속성
