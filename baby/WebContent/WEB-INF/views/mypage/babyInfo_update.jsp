                    	...
                    	<div class="row marginBot">
                      	...
                      	<div class="row marginBot" id="divPosition">
                        	...
                        	<div class="col-md-6 mypageContent" >
                              ...
                              <tr>
                                  <th>이름 : </th>
                                  <td><input type="text" name="babyName" class="borderBox form-control" value="하늘이"></td>
                                  <td></td>
                              </tr>
                              
                              <tr>
                                  <th>생년월일 : </th>
                                  <td><input type="text" id="babyBirth" class="borderBox form-control" value="2019-08-12"></td>
                                  <td><span class="font-text" id="inputAge">만 1세</span></td>
                              </tr>
                              ...
                              <tr>
                                  <th>키 : </th>
                                  <td><input type="number" name=babyHeight class="borderBox form-control" value="100"></td>
                                  <td class="font-text">cm</td>
                              </tr>
      
                              <tr>
                                  <th>몸무게 : </th>
                                  <td><input type="number" name="babyWeight" class="borderBox form-control" value="9"></td>
