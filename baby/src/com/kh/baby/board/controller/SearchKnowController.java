...
import com.kh.baby.board.model.service.SearchKnowService;
import com.kh.baby.board.model.vo.Board;
import com.kh.baby.board.model.vo.Page;

@WebServlet("/searchKnowledge")
public class SearchKnowController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			SearchKnowService service = new SearchKnowService();
			...
			Page pInfo = service.getPageInfo(currentPage, boardType, searchKey, searchValue);	
       	 	...
       	 	String path = "/WEB-INF/views/board/knowledge_list.jsp";
